...
if time_of_examine - 30 <= time_of_arriving <= time_of_examine:
    print("On time")
elif time_of_arriving <= time_of_examine - 31:
    print("Early")
...
if time_of_arriving > time_of_examine - 60 and time_of_arriving < time_of_examine:
    print(f"{minutes} minutes before the start")
elif time_of_arriving <= time_of_examine - 60:
    print(f"{hours}:{minutes:02d} hours before the start")
elif time_of_arriving > time_of_examine and time_of_arriving < time_of_examine + 60:
